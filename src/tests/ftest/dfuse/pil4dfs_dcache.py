...
class Pil4dfsDcacheCmd(ExecutableCommand):
    """Defines an object representing a test_pil4dfs_dcache unit test command."""
    ...
    def __init__(self, host, path, mnt):
        ...
        super().__init__("/run/test_pil4dfs_dcache/*", "test_pil4dfs_dcache", test_dir)
...
class Pil4dfsDcache(DfuseTestBase):
    ...
    def test_pil4dfs_dcache(self):
        ...
        self.log.info("Running test_pil4dfs_dcache command")
